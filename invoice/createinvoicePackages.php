...
<div class="right_col" role="main">
  <div class="col-md-12 ">
    <div class="x_panel">
    <div class="x_title" style="border:none; display: flex; justify-content: center; align-items: center; position: relative;">
  <h2 style="flex-grow: 1; text-align: center;">New Package Invoice <small></small></h2>
      ...
      <div class="x_content">
        <form class="form-horizontal form-label-left" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"
          ...
          <div class="form-group row">
            ...
            <input type="text" class="form-control" id="nonNumericInput" name="customername"
          ...
          <div class="col-md-6 col-sm-6 ">
            ...
            <input type="number" class="form-control" id="limitedinput" name="customermobile"
          ...
          <div class="col-md-6 col-sm-6  form-group has-feedback">
            ...
            <div class="col-md-6 col-sm-6 ">
              ...
              <select class="form-control" name="services" id="select_box">
                <option class="form-control" style="color: #756969; background-color: white; border: none; width: 100%;"
                  value="">-Service Name select-</option>
          ...
          <div class="table-responsive">
            <table class="table table-striped jambo_table bulk_action">
                    ...
                    if ($percentage == null) { ?>
                      <td>
                        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                          ...
                          <input type="hidden" class="text-field" name="servicesellingprice"
                            value="<?= @$value['ServicePrice'] ?>">
                          <button type="submit" name="action" value="discounts" class="action-button"
              ...
              <tfoot>
                  ...
                  <?php } else { ?>
                    <td style="display: flex; align-items: center;">
                      <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        ...
                        <input type="hidden" class="text-field" name="services" value="<?= @$value['ServicesID'] ?>">
                        <input type="hidden" class="text-field" name="netsellingprices"
                          value="<?= @$_SESSION['nettotalz'] ?>">
                        <button type="submit" name="action" value="special" class="action-button "
                          style="display: none; padding: left 5px;">Action</button>
                ...
                <tr>
                  <td colspan="4" class="text-end">Net Total amount</td>
                  <td> <?php $net = ($total - ($totaldiscount + @$spcdiz));
