      ...
      <div class="x_panel tile fixed_height_320">
        ...
        <div class="x_content">
          <table class="" style="width:100%">
            ...
            <tr>
              <td>
                <canvas id="myDoughnutChart" class="myDoughnutChart" height="140" width="140"
      ...
      <div class="x_panel tile fixed_height_320">
        ...
        <div class="x_content">
          <table class="" style="width:100%">
            ...
            <tr>
              <td>
                <canvas id="myDoughnutCharts" class="myDoughnutChart" height="140" width="140"
                  style="margin: 15px 10px 10px 0"></canvas>
              </td>
              <td>
                <!-- start php generating for stylist sales pie chart -->
      ...
      <div class="x_panel tile fixed_height_320">
        ...
        <div class="x_content">
          <table class="" style="width:100%">
            ...
            <tr>
              <td>
                <canvas id="myDoughnutChartcashout" class="myDoughnutChartcashout" height="140" width="140"
                  style="margin: 15px 10px 10px 0"></canvas>
              </td>
              <td>
