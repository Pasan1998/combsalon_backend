  ...
  <div class="row" style="display: inline-block;">
    <div class="tile_count">
      <div class="col-md-3 col-sm-4  tile_stats_count">
        <span class="count_top"><i class="fa fa-user"></i> Today Total Sale</span>
        <?php
        $db = dbConn();
     ...
     <div class="col-md-3 col-sm-4  tile_stats_count">
      <span class="count_top"><i class="fa fa-user"></i> Today Total Cash Sale </span>
       ...
       <div class="col-md-3 col-sm-4  tile_stats_count">
        <span class="count_top"><i class="fa fa-user"></i> Today Total Card Sale </span>

        <?php
        $db = dbConn();
        $sqltodaysalecash = "SELECT SUM(SaleAmount) AS total_salecash FROM tbl_sales WHERE DATE(SaleDate) = CURDATE() and PaymentType = '2'";
        $resulttodaysalecash = $db->query($sqltodaysalecash);
        if ($resulttodaysalecash->num_rows > 0) {
          $rowtodaysalecash = $resulttodaysalecash->fetch_assoc();
          $sale_cash = $rowtodaysalecash['total_salecash'];
      ...
      <!-- <div class="col-md-3 col-sm-4  tile_stats_count">
        ...
        // }
        if ($summery_discount) {
          $summery_discount = $summery_discount;
        } else {
          $summery_discount = 0;
        }

        if ($total_sale) {
          $sale_total_profit = $total_sale - ($summery_discount);
        } else {
          $sale_total_profit = 0;
        }
      ...
      <!-- cash balance start -->
      <div class="col-md-3 col-sm-4  tile_stats_count">
        <span class="count_top"><i class="fa fa-user"></i>Totay Cash Out </span>
        <?php

        $today_Cash_Balance = ($staff_cashouts + $management_cashouts);

        ?>
        <div class="count"><?= number_format($today_Cash_Balance, 2) ?></div>

      </div>

      <div class="col-md-3 col-sm-4  tile_stats_count">
        <span class="count_top"><i class="fa fa-user"></i>Totay Cash Balance </span>
        <?php

        $today_Cash_Balance = $sale_cash - ($staff_cashouts + $management_cashouts);
      ...
      <div class="x_panel tile fixed_height_320">
        ...
        <div class="x_content">
          <table class="" style="width:100%">
            ...
            <tr>
              <td>
                <canvas id="myDoughnutChart" class="myDoughnutChart" height="120" width="140"
                ...
                <table class="tile_info">
                  ...
                  if ($result_single_sale_emp->num_rows > 0) {
                    while ($row_single_sale_emp = $result_single_sale_emp->fetch_assoc()) {
                      ...
                      <tr>
                        <td>
                          <p><i class="fa fa-square color-icon"></i>
                            <?= ucwords($row_single_sale_emp['EmpFName']) . " " . ucwords($row_single_sale_emp['EmpLName']) ?>
                          </p>
                        </td>
      ...
      <div class="x_panel tile fixed_height_320">
        ...
        <div class="x_content">
          <table class="" style="width:100%">
            ...
            <tr>
              <td>
                <canvas id="myDoughnutCharts" class="myDoughnutChart" height="120" width="140"
                  style="margin: 15px 10px 10px 0"></canvas>
              </td>
              <td>
                <!-- start php generating for stylist sales pie chart -->
      ...
      <div class="x_panel tile fixed_height_320">
        ...
        <div class="x_content">
          <table class="" style="width:100%">
            ...
            <tr>
              <td>
                <canvas id="myDoughnutChartcashout" class="myDoughnutChartcashout" height="120" width="140"
                  style="margin: 15px 10px 10px 0"></canvas>
              </td>
              <td>
                  ...
                  if ($result_single_cashout_emp->num_rows > 0) {
                    while ($row_single_cashout_emp = $result_single_cashout_emp->fetch_assoc()) {
                      ...
                      <tr>
                        <td>
                          <p><i class="fa fa-square color-icon"></i>
                            <?= ucwords($row_single_cashout_emp['EmpFName']) . " " . ucwords($row_single_cashout_emp['EmpLName']) ?>
                          </p>
                        </td>
